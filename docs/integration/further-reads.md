...
In order to develop new knowledge in Bane NOR, we have collected some good reads we advice you to read. Please let us know if you have any good readings you think we should share. Happy reading and learning!
...
* [Injection attacks](https://owasp.org/www-project-top-ten/2017/A1_2017-Injection.html)
* [UK National Cyber Security Center Monitoring guidance](https://www.ncsc.gov.uk/collection/10-steps/logging-and-monitoring)
...
### Agile
* [What are OKRs? Easy Explanation And Practical Examples Of Objectives And Key Results](https://youtu.be/5qHqw8kfbms)
